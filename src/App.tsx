...
import {
  ...
  DATA_TO_INSERT_TO_CHAPTERS_TABLE_QUERY,
  DATA_TO_INSERT_TO_LESSONS_TABLE_QUERY,
} from "./consts";
...
function App() {
  ...
  React.useEffect(() => {
    try {
      if (db !== undefined) {
        const query =
          `${CREATE_CHAPTERS_TABLE_QUERY}${DATA_TO_INSERT_TO_CHAPTERS_TABLE_QUERY}${CREATE_LESSONS_TABLE_QUERY}${DATA_TO_INSERT_TO_LESSONS_TABLE_QUERY}` as const;
